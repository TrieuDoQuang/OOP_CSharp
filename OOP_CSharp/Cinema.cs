...
namespace OOP_CSharp
{
    ...
    {           
        public static List<VIP_Cus> dsvip = new List<VIP_Cus>();
        ...
        {
            Console.Write("------------------------------------------------------------\n");
            Console.Write("| Num  |   Tag   |      Name       |     Time     |  Room  |\n");
            Console.Write("------------------------------------------------------------\n");
        }
        ...
        public static void RunTotal()
        {
            ...
            for (int i = 0; i < dsphimtotal.Count(); i++)
            {
                ...
                Console.Write("|  " + Convert.ToString(i + 1).PadRight(2) + "  |  " + tmp.PadLeft(4) + "  ");
                dsphimtotal[i].Infor();
